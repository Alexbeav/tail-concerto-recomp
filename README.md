...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/tail-concerto-recomp/total)](https://github.com/Alexbeav/tail-concerto-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/tail-concerto-recomp/latest/total)](https://github.com/Alexbeav/tail-concerto-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/tail-concerto-recomp)](https://github.com/Alexbeav/tail-concerto-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Tail Concerto** built on
[psxrecomp](https://github.com/mstan/psxrecomp) and
[recomp-ui](https://github.com/RetroPortingToolKit/recomp-ui).

This is an owned-input setup kit. You supply your own SLUS-00660 disc image
...
|---|---|
| Region | USA |
| Disc serial | SLUS-00660 |
| Discs | 1 |
| Supported dump | Redump `Tail Concerto (USA).cue` as CUE/BIN or CHD |
| BIOS | SCPH-1001 (USA), 524288 bytes, SHA-256 `71af94d1e47a68c11e8fdb9f8368040601514a42a5a399cda48c7d3bff1e99d3` |

## Setup

1. Download the setup ZIP for your platform from [Releases](https://github.com/Alexbeav/tail-concerto-recomp/releases)
   and extract it into a writable folder.
2. Start `Tail_Concerto` (`.exe` on Windows).
...
named `diagnostic-mode.txt` next to `Tail_Concerto.exe` and start the game as
usual, or run `Tail_Concerto.exe --diagnostic`. Reproduce the problem, quit, then
run `Tail_Concerto.exe --collect-diagnostics`: it writes `diagnostics-<date>.zip`
