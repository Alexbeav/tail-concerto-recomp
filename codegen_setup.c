...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Tail Concerto",
    .project_root_env = "TAIL_CONCERTO_PROJECT_ROOT",
    .build_dir_env = "TAIL_CONCERTO_BUILD_DIR",
    .force_setup_env = "TAIL_CONCERTO_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_006.60_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Tail_Concerto",
    .prepare_note =
